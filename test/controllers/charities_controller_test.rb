...
class CharitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charity" do
    assert_difference('Charity.count') do
      post charities_url, params: { charity: { logo: @charity.logo, name: @charity.name, website: @charity.website } }
    end
  ...
  test "should update charity" do
    patch charity_url(@charity), params: { charity: { logo: @charity.logo, name: @charity.name, website: @charity.website } }
